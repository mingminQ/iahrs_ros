...
#ifndef IAHRS_SERIAL_SERIAL_PORT_HPP_
#define IAHRS_SERIAL_SERIAL_PORT_HPP_
...
namespace iahrs
{
    ...
    public:
         ...
         */
        bool receive_packet(char *rx_packet, unsigned int &packet_size) const;
         ...
         */
        bool transmit_packet(const char *tx_packet, const unsigned int &expected_packet_size) const;
...
#endif // IAHRS_SERIAL_SERIAL_PORT_HPP_